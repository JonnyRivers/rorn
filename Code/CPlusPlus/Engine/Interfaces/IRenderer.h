...
namespace Rorn
{
	namespace Engine
	{
		...
		public:
			...
			// Camera interface
			virtual unsigned int CreateFreeCamera(const Rorn::Maths::Vector3& position, const Rorn::Maths::EulerAngles& eulerAngles) = 0;
			...
			virtual void SetMainLight(const Rorn::Maths::Vector3& direction, const Rorn::Maths::Float4& colour) = 0;
			virtual unsigned int CreatePointLight(const Rorn::Maths::Vector3& position, const Rorn::Maths::Float4& colour, float luminosity) = 0;
